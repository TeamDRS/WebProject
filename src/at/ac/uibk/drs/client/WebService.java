...
public class WebService implements EntryPoint {
	...
	Label teamdrs2 = new Label();	//für Home panel -> mit eigene css daten
	...
	final Button changePassword = new Button("Passwort aendern");	//öffnet panel : 2 mal alte eingeben, + 1 mal neues
	...
	public void onModuleLoad() {
		...
		//name adresse, zum klicken : hat fahrrad, öbbticket, auto, 
